...
public interface Entities {
    ...
    Supplier<EntityType<ScarletBiplaneEntity>> SCARLET_BIPLANE = register("scarlet_biplane", EntityType.Builder
    ...
    Supplier<EntityType<EconomyPlaneEntity>> ECONOMY_PLANE = register("economy_plane", EntityType.Builder
